        ...
        if(isset($arrStreamFeatures["#"]["starttls"]) && 
          ...
          switch(TRUE) {
            case in_array("DIGEST-MD5",$mechanism):
              ...
              msg ("Attempting DIGEST-MD5 Authentication...");
              break;
            case in_array("PLAIN",$mechanism):
              ...
              $xml .= '</auth>';
              msg ("Attempting PLAIN Authentication...");
              break;
          }
        }
